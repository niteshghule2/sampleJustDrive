...
//   document.getElementsByClassName('dataTables_length').classList.add('bs-select');
// }
const display=()=>{
  // document.getElementById('dtBasicExample').DataTable();
  // document.getElementsByClassName('dataTables_length').classList.add('bs-select');
  document.querySelector('#dtBasicExample').DataTable();
            ...
            <div className="col-md-12">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <table id="dtBasicExample" onLoad={display} className="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
  <thead>
    <tr>
