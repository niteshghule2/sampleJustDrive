...
// function Car() {
class OngoingBookingList extends Component {
            ...
            <div className="col-md-12">
              <div className="card">
                <div className="card-header card-header-primary">
                  <h4 className="card-title ">All OnGoing Bookings </h4>
                  <p className="card-category"> Here is a list of Ongoing Bookings </p>
                </div>
